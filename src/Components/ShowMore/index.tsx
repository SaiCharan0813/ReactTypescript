...
const ShowMore:React.FC<props> = (show_sidebar) => {
        ...
        <Row>
            ...
            <div className="lt">
              ...
              <ul className="menu-list">
                ...
                <Link style={{textDecoration:'none'}} to={'/filter?category=Job_Title&value=Project Lead'}><li id="p-l" className="hidden-class font-family3 list-elm-color">Project Lead{`(${jbtitle_count[5]})`}</li></Link>
                <Link style={{textDecoration:'none'}} to={'/filter?category=Job_Title&value=Summer Analyst'}><li id="s-a" className="hidden-class font-family3 list-elm-color">Summer Analyst{`(${jbtitle_count[6]})`}</li></Link>
                <Link style={{textDecoration:'none'}} to={'/filter?category=Job_Title&value=Manager'}><li id="mgr" className="hidden-class font-family3 list-elm-color">Manager{`(${jbtitle_count[7]})`}</li></Link>

                <li className="blue font-family3 list-elm-color" id="view-more">
                  <a href="#" className= "hide-more view-clr font-family3 list-elm-color">View More</a>
                </li>
                <Link style={{textDecoration:'none'}} to={'/'}><li className="blue hidden-class font-family3 list-elm-color" id="view-less">
                  <a href="#" className="view-clr font-family3 list-elm-color" >View Less</a>
                </li></Link>
              </ul>
            </div>
