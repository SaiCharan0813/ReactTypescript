  ...
  job_titles.forEach((element) => {
    ...
    return (
      ...
      <div className="primary">
        <Link to={'/show_sidebar'}>
        <Row className="row">
            <Col sm={3}>
            <div className="lt">
            
              <ul className="menu-list1">
              <Link to={'/'}><button className="closex position-relative">X</button> </Link>
              ...
              <ul className="menu-list1">
                ...
                <nav className="navbar flex-container4">
    
                  <div className="logo-1">
                    <img src={logo} alt="logo" className="logo-nav2 position-relative" />
                 </div>
                 <div className="logo-2 position-relative">
                   <h1 className="head-nav2 blue position-relative font-family2">Employee Directory</h1>
                   <p className="text-nav2 position-relative font-family2 list-elm-color">
                      The Ultimate people Directory Experience
                   </p>
                 </div>
                 <div className="log-3"><h1 className="usergreeting-nav2 blue position-relative">Welcome,</h1></div>
                 <div className="logo-4">
                   <h1 id="recent-emp" className="username-nav2 head-text2 position-relative font-family2">Andrew Philips</h1>
                 </div>
                 <div className="logo-1">
                  <img
                   src={employeepic}
                   alt="employee1"
                   className="employee1-nav2 position-relative"
                  />
                 </div>
                </nav>
